...
export enum SagaAction {
  ...
  COURSES_CREATE_PARTICIPANTS = 'COURSES_CREATE_PARTICIPANTS',
  COURSES_GET_PARTICIPANTS = 'COURSES_GET_PARTICIPANTS',
  COURSES_DELETE_PARTICIPANTS = 'COURSES_DELETE_PARTICIPANTS',
}
